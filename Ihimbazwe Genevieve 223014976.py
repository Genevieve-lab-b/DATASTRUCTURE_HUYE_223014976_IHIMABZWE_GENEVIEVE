...
print('Q2.')
dailysales =[100,230,120,234,450,360,207]
...
Meeting =['derrick','iggy','ziggy']
Meeting.append('royoume')
print(Meeting)  

print('Q2')

shopp =['rice','beans','banana']
shopp.remove ('avocado')
print(shopp)
